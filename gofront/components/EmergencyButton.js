                         ...
                         Geolocation.getCurrentPosition(
                             (position) => {
                                 ...
                                 axios.post('/emergency', {
                                     emergencyPacket: { emergency_phone_number: user.emergency_phone_number, message: location, phone_number: user.phone_number, first_name: user.first_name, last_name: user.last_name, 
                                        license_plate: license_plate, brand: brand, model: model, color: color, license_plate: license_plate, brand: brand, model: model, color: color}
                                 })
                             },
                             (error) => {
